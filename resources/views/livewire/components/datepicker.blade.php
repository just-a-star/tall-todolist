<div x-data="{
    {{-- datePickerComponent(@entangle('due_date')), --}}
    dueDate: @entangle('due_date'),
    ...
    if (dueDate) {
        ...
        datePickerMonth = parsedDate.getMonth();
        datePickerYear = parsedDate.getFullYear();
        datePickerValue = datePickerFormatDate(parsedDate);
    }
    datePickerCalculateDays();
    " x-cloak>
