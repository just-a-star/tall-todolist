<div>
    ...
    <div aria-hidden="true"
        class="absolute inset-0 duration-300 -translate-y-1/2 border rounded-full opacity-25 aspect-video group-hover:-translate-y-1/4 bg-gradient-to-b from-gray-500 to-white dark:from-white dark:to-white blur-2xl dark:opacity-5 dark:group-hover:opacity-10">
    </div>
    <div class="relative">
        <div
        ...
        <div class="flex gap-3 py-4 -mb-8 border-t border-gray-200 dark:border-gray-800">
            <a href="#" download="/"
